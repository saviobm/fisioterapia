...
public class AvaliacaoDTO extends FisioterapiaDTO {
	...
	/**
	 * @param descricaoDignosticoFisioterapeutico the
	 *                                            descricaoDignosticoFisioterapeutico
	 *                                            to set
	 */
	...
	/**
	 * @param descricaoAparelhoGenitourinario the descricaoAparelhoGenitourinario to
	 *                                        set
	 */
